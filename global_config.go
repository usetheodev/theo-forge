...
func (g *GlobalConfig) DispatchTemplateHooks(tpl *TemplateModel) {
	g.mu.RLock()
	defer g.mu.RUnlock()
...
func (g *GlobalConfig) DispatchWorkflowHooks(wf *WorkflowModel) {
	g.mu.RLock()
	defer g.mu.RUnlock()
